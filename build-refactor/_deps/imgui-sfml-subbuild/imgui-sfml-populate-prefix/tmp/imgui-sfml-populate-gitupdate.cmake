...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "v2.5"
  WORKING_DIRECTORY "/mnt/c/Users/fddav/Desktop/TrafficSimulation/build-refactor/_deps/imgui-sfml-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("v2.5" tag_sha error_msg)
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/mnt/c/Users/fddav/Desktop/TrafficSimulation/build-refactor/_deps/imgui-sfml-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/mnt/c/Users/fddav/Desktop/TrafficSimulation/build-refactor/_deps/imgui-sfml-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
